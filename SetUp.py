...
class Window(QtGui.QMainWindow):
    ...
    def setVisuals(self):
        self.addLabel("background.png",0,0,800,600)
        self.addLabel("characters.png",290,20,300,40)
        self.addLabel("left.png",120,110,128,128)
        self.addLabel("right.png",590,110,128,128)
        self.addLabel("left.png",120,360,128,128)
        self.addLabel("right.png",590,360,128,128)
        self.addLabel("shutdown.png",720,530,80,80)
        self.addLabel("start.png",650,530,80,80)
        self.addLabel("scenes.png",290,300,200,40)
        self.addLabel1("fish.png",320,75,128,128)
        self.addLabel1("dog.png",320,75,128,128)
        self.addLabel1("lion.png",320,75,128,128)
        self.addLabel2("lion_converted.png",500,75,80,80)
        self.addLabel2("fish_converted.png",500,75,80,80)
        self.addLabel2("dog_converted.png",500,75,80,80)
        self.addLabel3("dog_converted.png",200,75,80,80)
        self.addLabel3("lion_converted.png",200,75,80,80)
        self.addLabel3("fish_converted.png",200,75,80,80)
        self.addLabel4("campo.png",340,360,120,120)
        self.addLabel4("campo2.png",340,360,120,120)
        self.addLabel4("sea.png",340,360,120,120)
        self.addLabel("add.png",440,201,20,20)
        self.addLabel("add.png",450,470,20,20)
